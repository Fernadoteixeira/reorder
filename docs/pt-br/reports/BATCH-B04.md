...
| `docs/architecture/subscriptions.md` | `docs/pt-br/docs/architecture/subscriptions.md` | 13845 | 17078 | `true` | `UTF-8` | `validated` |
| `docs/roadmap/activity-log.md` | `docs/pt-br/docs/roadmap/activity-log.md` | 2365 | 3101 | `true` | `UTF-8` | `validated` |
| `docs/roadmap/analytics.md` | `docs/pt-br/docs/roadmap/analytics.md` | 4649 | 6015 | `true` | `UTF-8` | `validated` |
| `docs/roadmap/implementation-plan.md` | `docs/pt-br/docs/roadmap/implementation-plan.md` | 11935 | 15761 | `true` | `UTF-8` | `validated` |
| `docs/roadmap/settings.md` | `docs/pt-br/docs/roadmap/settings.md` | 5244 | 7032 | `true` | `UTF-8` | `validated` |
