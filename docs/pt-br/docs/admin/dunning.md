...
### Mark Não Recuperado Confirmation
...
The implemented Dunning (Cobrança) UI intentionally stays close to the existing Admin language used elsewhere in the plugin:
