# Registro de Atividades Architecture
...
### Cancelamento e Retenção Events
...
## Scope Decision for Planos e Ofertas
...
## Current Renovação Emission Scope
