...
- `404 not_found`
  Assinatura does not exist.

## 2.1 Order Detail Assinatura Summary
...
- `404 not_found`
  Assinatura does not exist.
- `409 conflict`
  Assinatura cannot be paused from its current state.
...
- `404 not_found`
  Assinatura does not exist.
- `409 conflict`
  Assinatura cannot be resumed from its current state.
...
- `404 not_found`
  Assinatura does not exist.
- `409 conflict`
  Assinatura cannot be cancelled from its current state.
