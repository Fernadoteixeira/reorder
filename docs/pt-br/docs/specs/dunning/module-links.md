# Reorder: Dunning (Cobrança) Module Links Spec
...
- the current Dunning (Cobrança) domain contract can be supported by scalar references and case-level error fields
...
### Renovação-cycle link semantics
