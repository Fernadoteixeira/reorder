# Reorder: Dunning (Cobrança) Query and Admin Read Model Spec
...
This preserves the aggregate boundaries already established in earlier Dunning (Cobrança) decisions.
