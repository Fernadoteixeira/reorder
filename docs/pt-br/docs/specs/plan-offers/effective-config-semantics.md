# Reorder: Planos e Ofertas Effective Config Semantics Spec
...
## 12. Assinatura semantics

Assinaturas must consume effective config at decision time, not as an always-live dependency.
...
## 15. Assinatura snapshot semantics
...
8. Assinatura workflows validate against resolved effective config, then persist their own snapshots.
