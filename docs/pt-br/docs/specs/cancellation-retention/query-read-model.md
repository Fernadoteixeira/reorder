# Reorder: Cancelamento e Retenção Query and Admin Read Model Spec
...
### Dunning (Cobrança) and renewal enrichment

Dunning (Cobrança) and renewal summaries should use query-time enrichment by `subscription_id`.
